...
exports.flow = {
    triggers: {
        each: {
            ...
            properties: [
                propertyTypes_1.propertyTypes.numberX
            ],
    ...
    actions: {
        pin: {
            ...
            run: async ({ countingMessage }) => await countingMessage.pin().catch(async () => {
                ...
                if (pinned.size == 50)
                    await pinned.last().unpin().then(() => countingMessage.pin().catch(() => null)).catch(() => null);
            })
        },
        lock: {
...
for (const i in exports.flow.triggers)
    exports.flow.triggers[i] = Object.assign({
        short: "N/A",
        long: null,
        properties: [],
        explanation: "N/A",
        check: (any) => any
    }, exports.flow.triggers[i]);
for (const i in exports.flow.actions)
    exports.flow.actions[i] = Object.assign({
        short: "N/A",
        long: null,
        properties: [],
        explanation: "N/A",
        run: () => null
    }, exports.flow.actions[i]);
